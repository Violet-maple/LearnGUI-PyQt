...
from PyQt5.QtWidgets import QWidget, QLabel, QPushButton, QVBoxLayout, QDesktopWidget, QToolButton, QGridLayout
from PyQt5.QtCore import Qt, QPoint, QSize
from PyQt5.QtGui import QFont, QCursor, QIcon, QPixmap, QPalette, QBrush, QPainter, QColor
...
class QTitleLabel(QLabel):
    ...
    def __init__(self, *args):
        ...
        # self.pixMap = QPixmap('./img/qq.ico')
...
class QUnFrameWindow(QWidget):
    ...
    def load_btn(self):
        ...
        # self.recommend_button_1.move(40, 40)
        self.button = QPushButton(self)
        self.button.setStyleSheet("QPushButton{border-image: url(img/qq.ico)}"
                                  "QPushButton:hover{border-image: url(img/qq.ico)}"
                                  )
